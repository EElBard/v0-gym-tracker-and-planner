  ...
  return (
    <div className="flex flex-col min-h-svh">
      ...
      <main className="flex-1">
        <section className="relative container px-4 md:px-6 mx-auto py-16 md:py-24 lg:py-32 overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center gap-6 md:gap-8 max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-balance text-gradient">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Button asChild size="lg" className="glow hover:scale-105 transition-all">
...
function FeatureCard({
  ...
  return (
    <div className="flex flex-col items-center text-center gap-4 p-6 rounded-xl border border-white/5 bg-card/50 backdrop-blur-sm hover:-translate-y-1 hover:glow transition-all duration-300">
      <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-primary/20 shadow-[0_0_15px_rgba(var(--primary),0.5)]">
